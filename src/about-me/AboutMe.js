    ...
    <div className="AboutMe">
      ...
      <div className="AboutMe-text-img-wrapper">
        ...
        <div className="AboutMe-text" tabIndex={0}>
          ...
          <p>I was inspired to start programming after discovering <Link to="#" onClick={() => window.open("https://musiclab.chromeexperiments.com")}>Google's Chrome Music Lab</Link> and trying it out in my music classroom in 2019. It was an uncanny combination of my interest in music, technology, and accessibility and it made me realize that something was missing in my dream professional toolkit. From that point on, I taught myself how to code in Python and Javascript on and off. Eventually, I decided to take software engineering more seriously as a career and enrolled in Springboard's software engineering program, where I learned about frontend and backend technologies.</p>
