    ...
    <main className="AboutMe">
      ...
      <div className="AboutMe-text-img-wrapper">
        ...
        <div className="AboutMe-text" tabIndex={0}>
          ...
          <b>I'm currently seeking a role in frontend web development! <Link to="#" onClick={() => window.open("https://docs.google.com/document/d/18oRb8BghIT_kmwTY2EXB03Lq9laVucn2t3BIKQmun7Y/edit?usp=sharing")}>Click here to check out my resume.</Link></b>
        </div>
      </div>
      <NavContact />
    </main>
