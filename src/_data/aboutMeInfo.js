...
export const description = <>
  ...
  <p>I love building useful and delightful apps that are hopefully delightful. Almost everything I've built with code so far had a real purpose for me. I've built apps for my classes when I worked as a music teacher and for getting a feeding schedule for my new pet lizard going. I felt that this was the best way for me to learn how to code; building simple CRUD apps, todo lists, and Javascript calculators just wasn't cutting it for me.</p>
  <p>When I'm not building (or learning about building) software, I enjoy...</p>
  <p>🎹 <i>Music:</i> I've been playing music since I was a teen, mainly piano, synths, and messing around with Logic Pro. I like making electronic music that sounds like prog rock/metal. Learning Sonic Pi now that I can code. Check out my Soundcloud link in the navbar below to listen to my work!</p>
  <p>🥘 <i>Cooking:</i> Italian, Arab, Asian, burgers, vegan, you name it. My signature dish is chocolate peanut butter bars topped with marshmallows and flavored with cinnamon.</p>
  <p>🪴 <i>Gardening:</i> My fiancee and I grew a jungle in our apartment during lockdown. One of my goals is to create an app that tells me when to water my plants.</p>
  <p>🥋 <i>Martial arts:</i> I did tae kwon do in my teens and karate in my 20s. I switched to kung fu for my 30s because I stopped enjoying the competitiveness of karate.</p>
  <p>🎮 <i>Video games:</i> Just got a Nintendo Switch recently and I'm on a huge nostalgia kick right now. Currently addicted to Super Smash Bros. Ultimate and Pokemon.</p>
  <p>📈 <i>Playing the stock market:</i> My fiancee and I recently started our journey to better financial literacy. I bought a few shares recently and I'm just sitting on them now.</p>
</>;
...
// Personal
  // I'm originally from New York City. Born and raised in Brooklyn and now living in the Bronx with my fiancee, Melody (we worked on this for a hackathon together), and our pets, 🐈 Milo and 🦎 Unity (I made this when I was learning what Unity eats). I'm also on the autism spectrum, which probably explains my interest in neurodiversity.
  // Other than programming and music, I love...
  // 🥘 <i>Cooking:</i> Italian, Arab, Asian, burgers, vegetarian, you name it. I'm one of those people who actually love cooking for guests. My signature is chocolate peanut butter bars topped with marshmallows and flavored with cinnamon.
  // 🪴 <i>Gardening:</i> My fiancee and I grew a jungle in our apartment during lockdown. One of my goals is to create an app that tells me when to water our plants.
  // 🥋 <i>Martial arts:</i> I did tae kwon do in my teens and hold a black belt in karate. I switched to kung fu because I recently stopped enjoying the competitiveness of karate.
  // 🎮 <i>Video games:</i> Just got a Nintendo Switch recently and the first games I bought are nostalgic... Currently addicted to Pokemon.