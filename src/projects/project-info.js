...
const projects = [
  ...
  },
  {
    ...
    learnedHowTo: ['collaborate with a UX designer', 'work efficiently under tight time constraints', 'store art data in a database and call on that data to reproduce a smaller version of that art'],
  ...
  },
  {
    ...
    description: <p>An app that I invented for helping students identify their emotions. You describe how happy and energetic you feel using icons and you get an emotion and a song back based on the input. <b>This project is now deprecated and the concept is currently being incorporated into Art Buddy as the Mood Meter!</b></p>,
    learnedHowTo: ['apply my programming skills to solving a real problem', 'work with only vanilla JS - no frontend framework'],
